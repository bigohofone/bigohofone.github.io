...
import { DescriptionStyles } from './aboutmeStyles.jsx';


const SCROLL_PER_STEP = window.innerHeight * 0.5;
...
export default function Description() {
    ...
    // A. 텍스트 데이터 로드
    useEffect(() => {
        const path = `/data/aboutme/description.${locale}.txt`;
                        ...
                        (() => {
                            ...
                            return paragraphs.map((para, pIndex) => {
                                if (!para || para.length === 0) {
                                    return (
                                        <div key={`p-${pIndex}`} style={{ height: '1.5rem' }} />
                                    );
                                }
