...
// Expand braced author groups — "{A, B}*, C" → "A*, B*, C" — for plain text.
function plainAuthors(authors) {
  return String(authors).replace(/{([^}]+)}([*†]?)/g, (_, names, marker) =>
    names.split(", ").map((n) => `${n}${marker}`).join(", ")
  )
}
          ...
          {education.items.map((item, index) => (
            <View key={index} wrap={false}>
              ...
              <View style={styles.entry}>
                ...
                <Text style={styles.entryDescription}>{item.major}; {item.description}</Text>
              </View>
            </View>
          ))}
        </View>
            ...
            <View key={index} wrap={false}>
              ...
              <View style={styles.listItem}>
                ...
                <View style={styles.listItemContent}>
                  ...
                  <Text>{plainAuthors(item.authors)}</Text>
                  <Text>
